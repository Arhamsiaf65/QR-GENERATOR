...
import { Download, Printer, User, Phone, Mail, BookOpen } from "lucide-react"; // Import relevant icons
...
function GenerateQRCode() {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-blue-100 p-4 ">
            <div className="w-full md:max-w-md py-4 px-4 md:px-8 space-y-6 transform transition-all duration-300 hover:scale-105">
                <form onSubmit={generateQRCode} className="space-y-4">
                    ...
                    <div class="flex items-center justify-center w-full">
                        ...
                        for="dropzone-file" class="flex flex-col items-center justify-center w-full rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 ">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                <svg class="w-8  mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
            ...
            {/* QR Code Section */}
            <div className="w-full md:w-auto flex flex-col items-center space-y-4 animate-fade-in shadow-2xl shadow-blue-800 sm:shadow-none md:to-blue-500 py-8 px-4 md:px-8 md:ml-4 lg:ml-16 rounded-xl md:rounded-3xl mt-6 md:mt-0 md:bg-blue-500">
                ...
                <div className="flex space-x-4 text-white text-lg">
                    <button onClick={() => handleDownload(qrRef, 'jpg')} className="flex text-blue-950 bg-white sm:bg-transparent rounded-full sm:rounded-none px-4 py-0.5 sm:text-white items-center space-x-2">
                        <Download size={16} />
                        <span>JPG</span>
                    </button>

                    <button onClick={() => handleDownload(qrRef, 'png')} className="flex items-center bg-blue-950 text-white sm:text-white sm:bg-transparent rounded-full sm:rounded-none px-4 py-0.5 space-x-2">
                        <Download size={16} />
                        <span>PNG</span>
                    </button>
                </div>
